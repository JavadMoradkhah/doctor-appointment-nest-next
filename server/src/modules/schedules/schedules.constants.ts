...
export const ERR_MSG_SCHEDULE_MIN_DURATION = 'روز کاری حداقل باید یک ساعت باشد';

export const ERR_MSG_SCHEDULE_MAX_DURATION =
  'روز کاری حداکثر باید ۱۲ ساعت باشد';

export const ERR_MSG_SCHEDULE_BREAK_START_MIN_DIFF_WITH_START_TIME =
  'زمان استراحت حداقل باید یک ساعت بعد از شروع روز کاری باشد';

export const ERR_MSG_SCHEDULE_BREAK_TIME_MIN_DURATION =
  'زمان استراحت حداقل باید 15 دقیقه باشد';

export const ERR_MSG_SCHEDULE_BREAK_TIME_MAX_DURATION =
  'زمان استراحت حداکثر باید 6 ساعت باشد';

export const ERR_MSG_SCHEDULE_BREAK_END_TIME_BEFORE_SCHEDULE_END_TIME =
